...
function M.toggle()
	...
	if index > #vim.g.tairiki_config.toggle_style_list then index = 1 end
...
function M.setup(opts)
	...
	if vim.g.tairiki_config.toggle_style_key then
		vim.api.nvim_set_keymap('n', vim.g.tairiki_config.toggle_style_key, '<cmd>lua require("tairiki").toggle()<cr>',
